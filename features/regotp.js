...
const handler = async (m, {
    ...
    let pp = await conn.profilePictureUrl(who, 'image').catch((_) => "https://telegra.ph/file/e3fef8e6b368060e0ec7d.png");
...
async function createOtpCanvas(avatar) {
    ...
    const captchaBuffer = await new canvafy.Captcha()
        .setBackground("image", "https://telegra.ph/file/5861df316e08b24def2e4.jpg")
