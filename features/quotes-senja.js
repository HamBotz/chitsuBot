var canvafy = require("canvafy");

var handler = async (m, { conn, usedPrefix, command }) => {
  var cita = pickRandom(global.motivasi)
  var pp = await conn.profilePictureUrl(m.sender, 'image')
  var welcome = await new canvafy.WelcomeLeave()
  .setAvatar(pp)
  .setBackground("image", "https://pub-3626123a908346a7a8be8d9295f44e26.r2.dev/generations/ee5d4083-9a24-4520-8f76-60229f33d900-0.png")
  .setTitle(cita)
  .setDescription(wm)
  .setBorder("#2a2e35")
  ...
  .build();
  conn.sendFile(m.chat, welcome, '', cita, m);
}

handler.command = handler.help = ['senja']
handler.tags = ['quotes']
