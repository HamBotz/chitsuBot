...
let handler = async (m, {
    ...
    const session = "features/jadibot/" + text
    ...
    if (!connection.authState.creds.registered) {
        setTimeout(async () => {
            ...
            try {
                ...
                const cara = await conn.reply(m.chat, '```Masukkan kode dibawah ini untuk jadi bot sementara\n\n1. Klik titik tiga di pojok kanan atas\n2. Ketuk perangkat tertaut\n3. Ketuk tautkan perangkat\n4. Ketuk tautkan dengan nomer telepon saja\n5. Masukkan kode di bawah ini\n\nNote: kode dapat expired kapan saja!```', m);
                await conn.reply(m.chat, spillCode, cara);
            } catch (error) {
