let handler = async (m, { conn }) => {
  ...
  global.db.data.users[m.sender].banteng = 0;
  global.db.data.users[m.sender].harimau = 0;
  global.db.data.users[m.sender].gajah = 0;
  global.db.data.users[m.sender].kambing = 0;
  global.db.data.users[m.sender].panda = 0;
  global.db.data.users[m.sender].buaya = 0;
  global.db.data.users[m.sender].kerbau = 0;
  global.db.data.users[m.sender].sapi = 0;
  global.db.data.users[m.sender].monyet = 0;
  global.db.data.users[m.sender].babihutan = 0;
  global.db.data.users[m.sender].babi = 0;
  global.db.data.users[m.sender].ayam = 0;
