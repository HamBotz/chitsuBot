let handler = async (m, { conn, usedPrefix, participants }) => {
  ...
  m.reply(
    `*Pet Kamu* (🦚griffin ${global.db.data.users[m.sender].griffin}) ⚔️menantang 🦚griffinnya *${conn.getName(lawan)}* (🦚griffin ${global.db.data.users[lawan].griffin}) lagi berkelahi.\n\nTunggu ${lamaPertarungan} menit lagi dan lihat siapa yg menang🎮.`,
  );
